...
export default function FeaturesHighlightSection() {
  ...
  return (
    <section className="flex flex-col items-start gap-10 max-[500px]:gap-5 w-full pt-[120px] max-[1000px]:pt-10 max-[1100px]:pl-[50px] max-[767px]:pl-[25px] pl-[90px] overflow-hidden">
      ...
      <div className="flex items-center gap-[26px] mx-auto pb-[73px] max-[1000px]:pb-10">
        ...
        <button 
          className="w-[57px] h-[57px] max-[767px]:w-10 max-[767px]:h-10 rounded-[10px] bg-[#ffff]/90"
          onClick={nextCard}
        >
