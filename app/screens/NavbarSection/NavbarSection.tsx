    ...
    <div className="flex items-center gap-12 max-[1100px]:gap-5 max-[420px]:gap-[10px] w-full max-w-[794px]">
      <div className="relative w-full max-w-[603px]  h-[69px] max-[767px]:h-10">
        <Input
          ...
          className=" focus:outline-none focus:ring-0 focus-visible:ring-0 focus:border-[#9b91913b] w-full h-full bg-[#ffffff] rounded-[14px] border border-[#9b91913b] px-5 max-[420px]:px-3 py-5 max-[767px]:py-3 font-Poppins font-medium text-[#000000] placeholder:text-[#bab9bc] text-[19px] max-[767px]:text-[14px] tracking-[0] leading-[100%]"
        />
         <img
